...
\title{COMBINE\\ combine.org.au}
\author{The ISCB Regional Student Group for Australia}
...
\begin{tikzpicture}
  ...
  \blocknode{About Us}%
  {
        ...
        \includegraphics[width=0.6\linewidth]{./images/COMBINE-logo.jpg}
  ...
  \begin{minipage}[c]{\linewidth}
    ...
    \begin{itemize}
        ...
        \item Student council symposiums held annually at ISCB conferences:
        \begin{itemize}
        
        \item Intelligent Systems for Molecular Biology (ISMB)
        \item European Conference on Computational Biology (ECCB)
    \end{itemize}
    \end{itemize}
...
\end{minipage}
  ...
  {  \includegraphics[width=1\linewidth]{./images/COMBINE-collage.jpg}
    ...
    \bp{\bfseries Software Carpentry Bootcamp: Python, Bash, Git} (workshop)\\
    In partnership with Melbourne University ITS Research\\[1ex]
   \bp{\bfseries Wikipedia edit-a-thon \& Pizza Lunch} (workshop/social)\\
	Drs. Gayle Philip, Bernie Pope, and Geoff Macintyre.\\[1ex]
	\bp{\bfseries Machine Learning } (seminar)\\
    Dr.~Cheng Soon Ong, NICTA\\[1ex]
...
\includegraphics[height=45mm]{./images/wiki1.jpg}  \includegraphics[height=45mm]{./images/wiki2.jpg}  \includegraphics[height=45mm]{./images/abn.jpg}
  ...
  {
The COMBINE Student Symposium  is an opportunity for students and early-career researchers in computational biology, bioinformatics, and the life sciences to share their research with each other.\\
...
Symposium 2013 included over 50 attendees, a careers panel and prizes for the winning presentations.
  ...
  {
   \begin{itemize}
    	\item COMBINE with us! Want to bring COMBINE to your own state? We're looking for volunteers to set up events around Australia. 
        \item Contact us for assistance in organising workshops, seminars and social events in your area.
        \item Present your work at a COMBINE event before\\ attending conferences!
        \item Are you an expert on $x$? Give a workshop on $x$!
    \end{itemize}
    \vspace{1ex}\\

  \raisebox{-.25\height}{\includegraphics[height=15mm]{./images/facebooklogo.png}} \bp{Combine.Australia
}\\[2ex]
 \raisebox{-.25\height}{\includegraphics[height=15mm]{./images/twitter-logo.png}} \bp{@Combine\_AU}\\[2ex]
 \raisebox{-.25\height}{\includegraphics[height=15mm]{./images/google-plus-logo.png}} \bp{+CombineOrgAu}\\[3ex]
...
visit\\ \textbf{combine.org.au}
  ...
  We are proudly sponsored by:\\[2ex]
\begin{center}

    \centering
    \includegraphics[height=40mm]{./images/ICT-for-Life-Sciences-Forum-logo.png}\\[3ex]
    \includegraphics[height=40mm]{./images/ISCBSC-logo.png}\\[3ex]
    \includegraphics[height=40mm]{./images/logo_vlsci_(RGB).jpg}\\[1\baselineskip]
    \end{center}
    \vspace{1ex}
